...
from bespokeasm.line_object.directive_line import DirectiveLine, AddressOrgLine, FillDataLine, FillUntilDataLine

class TestDirectiveLines(unittest.TestCase):
    def test_org_directive(self):
        o1 = DirectiveLine.factory(1234, '.org $100', 'set address to 0=x100')
        ...
        o2 = DirectiveLine.factory(5678, '.org 1024', 'set address to 1024')
        self.assertIsInstance(o2, AddressOrgLine)
        self.assertEqual(o2.address(), 1024)

        o3 = DirectiveLine.factory(1357, '.org b100000000000', 'set address to 2048')
        self.assertIsInstance(o3, AddressOrgLine)
        self.assertEqual(o3.address(), 2048)

        o4 = DirectiveLine.factory(1357, '.org 0xFFFF', 'set address to 54K')
        ...
        with self.assertRaises(SystemExit, msg='non-numeric address should fail'):
            o5 = DirectiveLine.factory(1357, '.org a_label', 'set address to a label')

    def test_fill_directive(self):
        o1 = DirectiveLine.factory(1234, ' .fill 32, $77', 'fill with luck sevens')
        ...
        o2 = DirectiveLine.factory(1234, ' .fill 0xFF, 0x2211', 'snake eyes')
        ...
        o3 = DirectiveLine.factory(1234, '.zero b100000000', 'zipity doo dah')
    ...
    def test_filluntil_directive(self):
        ...
        o1 = DirectiveLine.factory(1234, ' .zerountil $100', 'fill with nothing')
        ...
        o2 = DirectiveLine.factory(1234, '.zerountil 0xF', 'them zeros')
