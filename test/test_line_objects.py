...
class TestLineObject(unittest.TestCase):
    ...
    def test_data_line_creation(self):
        ...
        d1 = DataLine.factory(27, ' .byte $de, $ad, 0xbe, $ef', 'steak', 'big', TestLineObject.memzone)
        ...
        d2 = DataLine.factory(38, ' .byte test1, 12', 'label mania', 'big', TestLineObject.memzone)
        ...
        d3 = DataLine.factory(38, ' .byte test1, , 12', 'label mania', 'big', TestLineObject.memzone)
        ...
        d4 = DataLine.factory(38, ' .byte b1110', 'label mania', 'big', TestLineObject.memzone)
        ...
        d5 = DataLine.factory(42, f' .byte "{test_str}"', 'string of bytes', 'big', TestLineObject.memzone)
        ...
        d5a_values.extend([0])
        d5a = DataLine.factory(42, f' .cstr "{test_str}"', 'string of bytes', 'big', TestLineObject.memzone)
        ...
        d6 = DataLine.factory(38, ' .2byte test1, 12', '2 byte label mania', 'little', TestLineObject.memzone)
        ...
        d9a = DataLine.factory(38, '.8byte 0x0123456789abcdef', 'data masked!', 'little', TestLineObject.memzone)
        ...
        with self.assertRaises(SystemExit, msg='this instruction should fail'):
            DataLine.factory(42, ' .cstr 0x42', 'bad cstr usage', 'big', TestLineObject.memzone)
    ...
    def test_label_line_creation(self):
        ...
        l1 = LabelLine.factory(13, 'my_label:', 'cool comment', register_set, label_values, TestLineObject.memzone)
    ...
    def test_instruction_line_creation(self):
        ...
        ins1 = InstructionLine.factory(22, '  lda test1', 'some comment!', isa_model, TestLineObject.memzone)
        ...
        ins2 = InstructionLine.factory(22, '  hlt', 'stop it!', isa_model, TestLineObject.memzone)
        ...
        ins3 = InstructionLine.factory(22, '  seta (high_de + $00AD)', 'is it alive?', isa_model, TestLineObject.memzone)
        ...
        ins4 = InstructionLine.factory(22, '  lda test1+2', 'load it', isa_model, TestLineObject.memzone)
        ...
        ins5 = InstructionLine.factory(22, '  plus 8', 'plus it', isa_model, TestLineObject.memzone)
        ...
        ins6 = InstructionLine.factory(22, '  lda test1-2', 'load it', isa_model, TestLineObject.memzone)
    ...
    def test_bad_instruction_lines(self):
        ...
        with self.assertRaises(SystemExit, msg='this instruction should fail'):
            InstructionLine.factory(22, '  mov [a+2],5', 'move it', isa_model, TestLineObject.memzone)

        # this instruction should fail because register i is being used in a numeric
        # expression
        with self.assertRaises(SystemExit, msg='this instruction should fail'):
            InstructionLine.factory(22, '  add i+5', 'add it', isa_model, TestLineObject.memzone)
    ...
    def test_instruction_line_creation_little_endian(self):
        ...
        ins2 = InstructionLine.factory(22, 'set test1', 'set it!', isa_model, TestLineObject.memzone)
        ins2.set_start_address(1212)
        self.assertIsInstance(ins2, InstructionLine)
        ...
        ins3 = InstructionLine.factory(22, 'big $f', 'big money', isa_model, TestLineObject.memzone)
    ...
    def test_specifc_configured_operands(self):
        ...
        ins1 = InstructionLine.factory(22, 'mov i,[mar]', 'specific operands', isa_model, TestLineObject.memzone)
        ...
        ins2 = InstructionLine.factory(22, 'mov [sp+8],[mar]', 'specific operands', isa_model, TestLineObject.memzone)
        ...
        ins3 = InstructionLine.factory(22, 'mov a,[sp+8]', 'specific operands', isa_model, TestLineObject.memzone)
