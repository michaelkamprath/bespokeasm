...
class TestBytecodeObjects(unittest.TestCase):
    ...
    def test_bytecode_assembly(self):
        ...
        parts1 = [
            NumericByteCodePart(15, 4, True, 'big', test_line_id, 8, 8),
            NumericByteCodePart(3, 2, False, 'big', test_line_id, 8, 8),
            NumericByteCodePart(3, 2, False, 'big', test_line_id, 8, 8),
        ]
        ...
        parts2 = [
            NumericByteCodePart(8, 4, True, 'big', test_line_id, 8, 8),
            NumericByteCodePart(0x1122, 16, True, 'little', test_line_id, 8, 8),
            NumericByteCodePart(0x11223344, 32, True, 'little', test_line_id, 8, 8),
            NumericByteCodePart(0x8, 4, False, 'big', test_line_id, 8, 8),
        ]
    ...
    def test_composite_bytecode_part(self):
        ...
        p1 = NumericByteCodePart(1, 3, True, 'big', test_line_id, 8, 8)
        p2 = NumericByteCodePart(3, 2, True, 'big', test_line_id, 8, 8)
        p3 = ExpressionByteCodePart('var1+13', 4, True, 'big', test_line_id, 8, 8)

        c1 = CompositeByteCodePart([p1, p2], False, 'big', test_line_id, 8, 8)
        ...
        c2 = CompositeByteCodePart([p2, p1], False, 'big', test_line_id, 8, 8)
        ...
        c3 = CompositeByteCodePart([p1, p2, p3], False, 'big', test_line_id, 8, 8)
